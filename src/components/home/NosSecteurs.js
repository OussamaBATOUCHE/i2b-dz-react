                    ...
                    <div className="row mt--70 justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div className="serv-box s1 v5 bg-s1">
                                ...
                                <div className="content-box">
                                    <img className='at' src={`${process.env.PUBLIC_URL}/static/images/i2bproducts/white/at-white.png`} alt="at" />
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="serv-box s1 v5 bg-s3">
                                ...
                                <div className="content-box">
                                    <img className='ai' src={`${process.env.PUBLIC_URL}/static/images/i2bproducts/white/ai-white.png`} alt="ai" />
                                </div>
                            </div>
                            <div className='products-box border-s1'>
